...
/**
 * This is a game, a computer picks a random number in [0,100] range, user inputs numbers until he guesses it or he misses 6 times
 * You can't enter number lower than 0 or higher than 100
 * The program will give you hints, will tell you if last entered number is lower or higher than the number you are looking for
 * 
 * @author Haris Krkalić
 * BIT Camp
 */

public class GuessingGameMyWayPractice {
